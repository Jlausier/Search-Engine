...
import { GET_ME, REMOVE_BOOK } from '../utils/mutations'; // Import GraphQL queries and mutations
import Auth from '../utils/auth';
import { removeBookId } from '../utils/localStorage';

const SavedBooks = () => {
  const { loading, error, data } = useQuery(GET_ME); // Use the GET_ME query to fetch user data
  ...
  const handleDeleteBook = async (bookId) => {
    ...
    try {
      ...
      // If the mutation was successful, update the user data directly
